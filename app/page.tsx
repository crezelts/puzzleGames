      ...
      <div className="flex flex-col min-h-screen">
        ...
        <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
          ...
          <nav className="sm:ml-auto flex gap-4 sm:gap-6">
            <Link href='https://github.com/crezelts/puzzleGames' target="_blank" className="flex text-sm hover:underline underline-offset-4">
              <FontAwesomeIcon icon={faGithub} className='h-6 w-6 text-white -mt-1 mr-1' />
              <span className='-mt-0.5'>Github</span>
            </Link>
            <Link href='https://copyassignment.com/puzzle-game-in-python/' target="_blank" className="text-xs hover:underline underline-offset-4">
